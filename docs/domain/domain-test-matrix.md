...
| **Guitar Technique Preservation** (Preserve notes even if techniques are unsupported) | `guitar-technique-articulation.md` | Stage 4: ScoreIR Model | `test_intermediate_products.py` | Fret notes with unsupported bends/slides are compiled with technique warnings. | Notes with unsupported techniques are deleted or ignored, producing empty bars. |
