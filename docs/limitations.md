...
- Even compatible ASCII/MusicXML alignment does not currently allow `build-ir` to write ScoreIR. The project intentionally refuses with `ascii_scoreir_writing_not_implemented` until a future branch defines a safe ScoreIR-writing boundary.
