...
| Tab candidate extraction | `extract-tab` | First pass plus tiny, score-like, and uneven controlled generated-PDF fixtures |
| ScoreIR alignment | `build-ir` | Synthetic and controlled generated-PDF proof path with x-to-onset diagnostics |
